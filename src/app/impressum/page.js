const Impressum = () => {
  return (
    <div className="mx-auto min-h-[calc(100vh-320px)] max-w-4xl px-4 py-8">
      ...
      <div className="space-y-6 text-gray-700">
        ...
        <section>
          ...
          <a className="hover:underline" href="mailto:info@bostanci-art.de">
        ...
        <section>
          ...
          <div className="mt-6">
            ...
            <p>
              <span className="font-bold">E-Mail:</span>{" "}
              <a className="hover:underline" href="mailto:a.aziz@alkanaziz.com">
                a.aziz@alkanaziz.com
              </a>
            </p>
          </div>
        </section>
